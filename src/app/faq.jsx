...
export default function FAQSection() {
  ...
  return (
    <section className="bg-white py-[84px] px-[228px] flex flex-col items-center">
      <div className="w-[984px] flex flex-col items-center gap-[69px]">
        {/* Title */}
        <div className="flex flex-col items-center gap-[13px]">
          <h2 className="font-['Poppins'] text-[36px] leading-[47px] tracking-[-0.15px] font-normal text-[#2D1E1D] text-center">
            Domande Frequenti
          </h2>
        </div>
          ...
          {faqItems.map((item, index) => (
            ...
            >
              ...
              <button
                ...
                className="w-full p-6 flex items-center justify-between gap-[47px] hover:bg-[#F3EFEC] transition-colors duration-200"
              >
                <div className="flex flex-col items-start">
                  <h3 className="font-['Poppins'] text-[22px] leading-[31px] tracking-[-0.05px] font-normal text-[#404040] text-left">
                    {item.question}
                  </h3>
                </div>
              ...
              >
                <div className="px-6">
                  <div className="border-t border-[#DFD1C9] pt-4">
                    <p className="font-['DM_Sans'] text-base leading-6 text-[#404040]">
                      {item.answer}
                    </p>
                  </div>
                </div>
