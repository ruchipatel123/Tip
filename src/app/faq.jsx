          ...
          {faqItems.map((item, index) => (
            ...
            >
              ...
              <button
                ...
                className="w-full p-4 sm:p-6 flex cursor-grab items-center sm:items-center justify-between gap-4 sm:gap-8 lg:gap-[47px] hover:bg-[#F3EFEC] transition-colors duration-200"
              >
