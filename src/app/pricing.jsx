    ...
    <section className="bg-[#F1EBE7] px-4 sm:px-8 lg:px-16 xl:px-[163px] py-8 sm:py-12 lg:py-16 flex flex-col items-center">
      <div className="w-full max-w-[1114px] flex flex-col items-center gap-8 sm:gap-10 lg:gap-12">
        ...
        <div className="flex flex-col items-center text-center gap-4 sm:gap-6">
          <h2 className="text-[24px] sm:text-[28px] lg:text-[36px] leading-[32px] sm:leading-[38px] lg:leading-[47px] tracking-[-0.15px] font-normal text-black font-['Poppins'] px-4">
            Ti garantiamo i risultati:{' '}
            <br />
            soddisfatta o rimborsata
          </h2>
          <p className="font-['DM_Sans'] text-sm sm:text-base leading-[22px] sm:leading-[26px] text-black max-w-md lg:max-w-[442px] px-4">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-stretch gap-6 lg:gap-8 w-full max-w-[1200px]">
            ...
            <div className="flex flex-col justify-between gap-8 sm:gap-10 lg:gap-14 h-full min-h-[320px] lg:min-h-[360px]">
              <div className="flex flex-col gap-3 sm:gap-4">
                ...
                <div className="text-[#684744]">
                  <span className="font-['Poppins'] text-[24px] sm:text-[28px] leading-[32px] sm:leading-[36px] tracking-[-0.1px]">€23.99</span>
                  <span className="font-['Poppins'] text-[24px] sm:text-[28px] leading-[32px] sm:leading-[36px] tracking-[-0.1px]"> / month</span>
                </div>
          ...
          <div className="w-full max-w-sm lg:w-[350px] flex flex-col">
            ...
            >
              ...
              <span className="font-['DM_Sans'] text-sm sm:text-base leading-[20px] sm:leading-[26px] text-white font-normal">
                BEST VALUE
              </span>
            </div>
            ...
            <div className="bg-white rounded-b-2xl shadow-[0px_4px_20px_0px_rgba(0,0,0,0.1)] border border-black/10 p-4 sm:p-6 relative flex-1 min-h-[380px] lg:min-h-[430px]">
              <div className="flex flex-col justify-between h-full gap-8 sm:gap-10 lg:gap-14">
                <div className="flex flex-col gap-3 sm:gap-4">
                  ...
                  <div className="text-[#684744]">
                    <span className="font-['Poppins'] text-[24px] sm:text-[28px] leading-[32px] sm:leading-[36px] tracking-[-0.1px]">€13.33</span>
                    <span className="font-['Poppins'] text-[24px] sm:text-[28px] leading-[32px] sm:leading-[36px] tracking-[-0.1px]"> / month</span>
                  </div>
                  <div className="flex flex-wrap items-baseline gap-1.5 font-['DM_Sans'] text-xs sm:text-sm leading-[18px] sm:leading-[21px]">
              ...
              <div className="absolute top-4 sm:top-7 right-4 sm:right-[25px] bg-[#DFD1C9] rounded-full px-2 py-2 sm:py-[9px] shadow-[0px_0px_20px_0px_rgba(0,0,0,0.15)] h-7 sm:h-8 flex items-center">
                <span className="font-['DM_Sans'] text-[10px] sm:text-xs font-semibold leading-4 sm:leading-6 tracking-[0.1px] text-[#553B39] uppercase">
                  RISPARMIA IL 37%
                </span>
              </div>
            </div>
