...
export default function MobileSection() {
  ...
  return (
    <section className="bg-[#F1EBE7] pt-10">
      ...
      <div ref={containerRef} className="mt-50 relative">
        <div className="w-full md:w-1/2 absolute -top-200 right-20">
              ...
              >
                ...
                {index === 0 && (
                  <Image
                    ...
                    width={412}
                    height={184}
                    className="absolute -top-[35%] left-[42%] -translate-x-[42%]"
                  />
                )}
                ...
                {index === 0 && (
                  <Image
                    ...
                    width={612}
                    height={184}
                    className="absolute top-[110%] left-[20%] -translate-x-[20%]"
                  />
                )}
                {index === 1 && (
                  <Image
