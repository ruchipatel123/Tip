    ...
    <footer className="bg-[#553B39] text-white relative">
      ...
      <div className="flex flex-wrap justify-center gap-8 pt-20 pb-4 px-8">
        ...
        <div className="flex flex-col gap-[14px] w-[354px]">
          ...
          <div className="flex items-center gap-1">
            {/* Instagram */}
            <a href="#" className="p-1 opacity-90 hover:opacity-100 transition-opacity">
            ...
            <a href="#" className="p-1 opacity-90 hover:opacity-100 transition-opacity">
              <div className="w-[25px] h-[25px] flex items-center justify-center">
                <svg width="20" height="24" viewBox="0 0 20 24" fill="none">
                  <path d="M16.5 8.5C16.5 8.5 14.5 7.5 12.5 8.5V16.5C12.5 18.5 10.5 20.5 8.5 20.5C6.5 20.5 4.5 18.5 4.5 16.5C4.5 14.5 6.5 12.5 8.5 12.5V9.5C5 9.5 2 12.5 2 16.5C2 20.5 5 23.5 8.5 23.5C12 23.5 15 20.5 15 16.5V12C16.5 13 18.5 13 18.5 13V9.5C18.5 9.5 17.5 8.5 16.5 8.5Z" fill="white"/>
                </svg>
              </div>
            </a>
            ...
            <a href="#" className="p-1 opacity-90 hover:opacity-100 transition-opacity">
              <div className="w-[25px] h-[25px] flex items-center justify-center">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  ...
                  <path d="M8 14.5C10 13.5 14 13.5 16 14.5M7 11.5C10 10.5 14 10.5 17 11.5M6.5 8.5C10.5 7.5 13.5 7.5 17.5 8.5" stroke="white" strokeWidth="1.5" strokeLinecap="round"/>
                </svg>
              </div>
            </a>
          </div>
        ...
        <div className="flex flex-col gap-2 w-[313px]">
          ...
          <div className="flex flex-col">
            <a href="#" className="font-['DM_Sans'] text-base leading-[22px] text-white pb-[10px] hover:opacity-80 transition-opacity">
        ...
        <div className="flex flex-col items-end gap-1.5 pb-1.5">
          ...
          <a href="#" className="hover:opacity-80 transition-opacity">
            <div className="w-[132px] h-[44px] bg-black rounded-lg flex items-center justify-center">
              <svg width="132" height="44" viewBox="0 0 132 44" fill="none">
                <rect width="132" height="44" rx="8" fill="black"/>
                <text x="16" y="15" className="font-['SF_Pro_Display'] text-[9px] text-white">Scarica su</text>
                <text x="16" y="32" className="font-['SF_Pro_Display'] text-[20px] font-semibold text-white">App Store</text>
                <g transform="translate(93, 8)">
                  <path d="M20.12 15.37C19.23 14.02 17.53 13.16 15.97 13.16C14.73 13.16 13.64 13.75 12.97 14.65C12.3 15.55 12.01 16.72 12.01 17.89C12.01 19.46 12.54 20.87 13.53 21.85C14.52 22.83 15.93 23.36 17.5 23.36C19.07 23.36 20.48 22.83 21.47 21.85C22.46 20.87 22.99 19.46 22.99 17.89C22.99 16.72 22.7 15.55 22.03 14.65C21.36 13.75 20.27 13.16 19.03 13.16C17.47 13.16 15.77 14.02 14.88 15.37L20.12 15.37Z" fill="white"/>
                </g>
              </svg>
            </div>
          </a>
          ...
          {/* Google Play */}
          <a href="#" className="hover:opacity-80 transition-opacity">
            <div className="w-[136px] h-[40px] bg-black rounded-lg flex items-center justify-center">
              <svg width="136" height="40" viewBox="0 0 136 40" fill="none">
                <rect width="136" height="40" rx="6" fill="black"/>
                <text x="50" y="13" className="font-['Roboto'] text-[8px] text-white">DISPONIBILE SU</text>
                <text x="50" y="28" className="font-['Roboto'] text-[16px] font-medium text-white">Google Play</text>
      ...
      <div className="absolute top-[200px] right-[100px] flex items-end gap-2">
        ...
        <div className="w-10 h-10 bg-white/80 rounded-full flex items-center justify-center shadow-lg">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path d="M12 4L4 12M4 4L12 12" stroke="black" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
      ...
      <div className="fixed bottom-8 right-8 w-16 h-16 bg-[#98685E] rounded-[32px] flex items-center justify-center shadow-lg hover:bg-[#8a5d56] transition-colors cursor-pointer">
        <svg width="32" height="26" viewBox="0 0 32 26" fill="none">
          <path d="M28 0H4C1.8 0 0 1.8 0 4V18C0 20.2 1.8 22 4 22H8V26L14 22H28C30.2 22 32 20.2 32 18V4C32 1.8 30.2 0 28 0ZM8 13C7.4 13 7 12.6 7 12C7 11.4 7.4 11 8 11C8.6 11 9 11.4 9 12C9 12.6 8.6 13 8 13ZM16 13C15.4 13 15 12.6 15 12C15 11.4 15.4 11 16 11C16.6 11 17 11.4 17 12C17 12.6 16.6 13 16 13ZM24 13C23.4 13 23 12.6 23 12C23 11.4 23.4 11 24 11C24.6 11 25 11.4 25 12C25 12.6 24.6 13 24 13Z" fill="white"/>
        </svg>
      </div>
