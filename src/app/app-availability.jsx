  ...
  return (
    <section className="bg-white w-full py-12 sm:py-16 lg:py-20 overflow-hidden">
      ...
      <div className="flex flex-col items-center gap-6 sm:gap-8 px-4 sm:px-6 lg:px-8 mb-8 sm:mb-12 lg:mb-16">
        <h2 className="font-['Poppins'] text-3xl sm:text-[28px] lg:text-[36px] leading-[28px] sm:leading-[38px] lg:leading-[47px] tracking-[-0.15px] font-normal text-black text-center  max-w-[316px] md:max-w-4xl mx-auto px-8">
